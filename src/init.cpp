...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/coolpal-project/coolpal>";
    const std::string URL_WEBSITE = "<https://coolpal.org>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    g_connman->AddNode("47.75.154.202");
    g_connman->AddNode("47.75.175.238");
    g_connman->AddNode("119.23.204.69");
    g_connman->AddNode("39.108.208.176");
