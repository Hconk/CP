...
const char * const BITCOIN_CONF_FILENAME = "coolpal.conf";
const char * const BITCOIN_PID_FILENAME = "coolpal.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CoolPal";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/CoolPal";
#else
    // Unix
    return pathRet / ".coolpal";
#endif
#endif
}
