...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s coolpal-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coolpal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coolpal transaction") + "\n" +
              "  coolpal-tx [options] -create [commands]   " + _("Create hex-encoded coolpal transaction") + "\n" +
              "\n";
